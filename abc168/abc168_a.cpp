...
int main(){
    cin >> buf_answer;
    if ((((letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(2)) || (letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(4))) || ((letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(5)) || ((letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(7)) || (letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(9)))))){
        cout << Var("hon") << endl;
    } else {
        if ((((letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(0)) || (letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(1))) || ((letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(6)) || (letterOf(Var(buf_answer.asString().size()), buf_answer) == Var(8))))){
            cout << Var("pon") << endl;
        } else {
            cout << Var("bon") << endl;
        }
