...
int main(){
    ...
    for (int cnt_0=0;cnt_0<var_N.asNumber();cnt_0++){
        var_i += Var(1);
        if (((letterOf(var_i, var_S) == letterOf(var_i, var_T)) || (((letterOf(var_i, var_T) == Var(0)) && (letterOf(var_i, var_S) == Var("o"))) || ((((letterOf(var_i, var_S) == Var(1)) && (letterOf(var_i, var_T) == Var("l"))) || ((letterOf(var_i, var_S) == Var(0)) && (letterOf(var_i, var_T) == Var("o")))) || ((letterOf(var_i, var_S) == Var("l")) && (letterOf(var_i, var_T) == Var(1))))))){
            var_ans += Var(1);
        }
    }
    if ((var_ans == var_N)){
